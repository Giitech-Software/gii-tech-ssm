...
export async function getStaffAttendance(staffId: string) {
  const snapshot = await getDocs(query(collection(db, "staffAttendance"), where("staffId", "==", staffId)));
