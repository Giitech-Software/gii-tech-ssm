  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-100">
      <ScrollView contentContainerClassName="px-5 py-6" keyboardShouldPersistTaps="handled">
        ...
        <View className="rounded-3xl bg-indigo-950 p-6">
          <Text className="text-xs font-bold uppercase tracking-widest text-indigo-300">
            Administration
          </Text>
          <Text className="mt-3 text-3xl font-black text-white">{title}</Text>
          <Text className="mt-2 text-sm leading-5 text-indigo-100">{subtitle}</Text>
        </View>
        {children}
      </ScrollView>
    </SafeAreaView>
